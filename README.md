...
- **Ticket 8 — Fator de fadiga.** `DetectorDeFadiga` penaliza o IEE por pálpebra pesada (PERCLOS), fechamento prolongado e bocejo, com os limiares relativos à baseline do aluno. O fator vem de regras, e não do Random Forest — o porquê está em [`resultado_18_08.md`](./resultado_18_08.md). Sessões reais de webcam em 28/08 corrigiram cinco pontos do detector: o tempo que uma amostra pode representar tem teto (um buraco de 4 s na telemetria virava cochilo inventado), o mesmo fechamento não é cobrado duas vezes (episódio longo sai do PERCLOS, que caiu de 15,2% para os 3,3% do piscar involuntário; e olho fechado durante bocejo não vira microssono, de 23,0 para 8,0 pontos), cada episódio pesa pela idade dentro da janela em vez de valer cheio até sumir de uma vez, e o limiar de MAR voltou de 0,30 para 0,50 — o 0,30 tinha sido calibrado contra o DAiSEE, que não tem bocejos francos.
